  ...
  render() {
    return (
      <div className='container my-3'>
        ...
        <NewsItem title="myTitle" descirption="mydesc" imageUrl="https://cdn.24.co.za/files/cms/General/d/10743/97d776dc91734e98906c0e1b7f3b1afa.jpg" newsUrl="to do"/>
        </div>
        <div className='col-md-4'>   
        <NewsItem title="myTitle" descirption="mydesc"/> 
        </div>
        <div className='col-md-4'>   
        <NewsItem title="myTitle" descirption="mydesc"/> 
        </div>
